                        ...
                        <div className="flex flex-col items-center justify-center mt-1 gap-1">
                          <div className="flex flex-row items-center justify-center gap-2 bg-transparent rounded-lg px-3 py-2 shadow-md">
                            ...
                            <input
                              ...
                              style={{ width: '6.5ch', minWidth: '6.5ch', maxWidth: '6.5ch', color: 'white', appearance: !isAdmin ? 'none' : undefined, WebkitAppearance: !isAdmin ? 'none' : undefined, MozAppearance: !isAdmin ? 'none' : undefined }}
